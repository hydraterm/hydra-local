...
pub const SYSTEM_TERMINAL_PROJECT_ID: &str = maestro_shell::SYSTEM_TERMINAL_PROJECT_ID;
pub const SYSTEM_TERMINAL_WORKSPACE_ID: &str = maestro_shell::SYSTEM_TERMINAL_WORKSPACE_ID;
pub const SYSTEM_TERMINAL_WINDOW_ID: &str = maestro_shell::SYSTEM_TERMINAL_WINDOW_ID;
pub const SYSTEM_TERMINAL_TAB_ID: &str = maestro_shell::SYSTEM_TERMINAL_TAB_ID;
pub const SYSTEM_TERMINAL_SESSION_ID: &str = maestro_shell::SYSTEM_TERMINAL_SESSION_ID;
...
pub const PRODUCT_RECOVERY_PROJECT_ID: &str = maestro_shell::PRODUCT_RECOVERY_PROJECT_ID;
pub const PRODUCT_RECOVERY_WORKSPACE_ID: &str = maestro_shell::PRODUCT_RECOVERY_WORKSPACE_ID;
pub const PRODUCT_RECOVERY_WINDOW_ID: &str = maestro_shell::PRODUCT_RECOVERY_WINDOW_ID;
pub const PRODUCT_RECOVERY_TAB_ID: &str = maestro_shell::PRODUCT_RECOVERY_TAB_ID;
pub const PRODUCT_RECOVERY_SESSION_ID: &str = maestro_shell::PRODUCT_RECOVERY_SESSION_ID;
